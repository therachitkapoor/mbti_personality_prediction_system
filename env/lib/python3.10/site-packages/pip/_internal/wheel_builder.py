...
def should_build_for_install_command(
    req: InstallRequirement, check_binary_allowed: BinaryAllowedPredicate,
) -> bool:
...
def _build_one(
    ...
    try:
        ...
        logger.warning(
            "Building %s for %s failed: %s", artifact, req.name, e,
        )
        return None
...
def _clean_one_legacy(req: InstallRequirement, global_options: List[str]) -> bool:
    clean_args = make_setuptools_clean_args(
        req.setup_py_path, global_options=global_options,
    )
