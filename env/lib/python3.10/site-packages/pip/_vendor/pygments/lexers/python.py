...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        "classname": [(uni_name, Name.Class, "#pop"),],
        "import": [
        ...
        "rfstringescape": [(r"\{\{", String.Escape), (r"\}\}", String.Escape),],
        "fstringescape": [include("rfstringescape"), include("stringescape"),],
        "stringescape": [
            (
                r'\\([\\abfnrtv"\']|\n|N\{.*?\}|u[a-fA-F0-9]{4}|'
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "name": [(r"@[\w.]+", Name.Decorator), (r"[a-zA-Z_]\w*", Name),],
        "funcname": [
            include("magicfuncs"),
...
class PythonTracebackLexer(RegexLexer):
    ...
    tokens = {
        ...
        "intb": [
            ...
            (
                r"^([^:]+)(: )(.+)(\n)",
                bygroups(Generic.Error, Text, Name, Text),
                "#pop",
            ),
        ...
        "markers": [
            ...
            (r"^( {4,})([~^]+)(\n)", bygroups(Text, Punctuation.Marker, Text), "#pop"),
            default("#pop"),
        ],
    }
